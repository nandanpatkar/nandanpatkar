...
##<p>&nbsp;<img align="center" src="https://github-readme-stats.vercel.app/api?username=nandanpatkar&show_icons=true&theme=radical" alt="nandanpatkar" /></p>
...
<h3 align="center">A Passionate AIML Engineer | Generative AI Enthusiast</h3>
...
- 🔭 **Currently Working On:** [Crick_Chat](https://github.com/nandanpatkar/Crick_Chat)
- 🌱 **Currently Learning:** Generative AI (GenAI) and its applications in creative content generation.
- 📫 **How to Reach Me:** nandanpatkar14114@gmail.com
- 📄 **Know About My Experiences:** [My Resume](https://drive.google.com/drive/folders/1LNoedGsiz2bk41_Tp4pGNir-V0gTclR0?usp=drive_link)
- ⚡ **Fun Fact:** I debug bugs, projects, and sometimes people’s bad moods. My humor might not compile, but it always executes. 😏
...
- **Description:** Built a Generative AI model to create personalized blog posts and articles.
- **Tech Stack:** Python, TensorFlow, GPT-3, Hugging Face Transformers.
- **Highlights:** Fine-tuned GPT-3 for domain-specific content generation.

### **2. AI Art Generator**
- **Description:** Developed a tool to generate AI-based artwork using GANs (Generative Adversarial Networks).
- **Tech Stack:** PyTorch, StyleGAN2, OpenCV.
- **Highlights:** Created unique, high-resolution digital art pieces.

### **3. Chatbot with Personality**
- **Description:** Designed a chatbot with a unique personality using OpenAI's GPT-4 API.
- **Tech Stack:** Python, Flask, OpenAI API.
- **Highlights:** Integrated with a web app for real-time interaction.
